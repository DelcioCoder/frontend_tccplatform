import { Student } from "@/types/advisor";
...
export default function StudentCard({ student, onConnect }: StudentCardProps) {
    return (
        <article 
              ...
              aria-label={`Aluno: ${student.username}`}
            >
              <div>
              ...
              <button
                ...
                aria-label={`Solicitar orientação de ${student.username}`}
